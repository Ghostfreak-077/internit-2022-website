            ...
            <div className="footer-main">
                <div className="footer-left">
                    ...
                    <div className="footer-links">
                        ...
                        <a href="/"><AiFillLinkedin size={30} className="icon-btn-1"/></a>
                        <a href="/"><AiFillTwitterCircle size={30} className="icon-btn-2"/></a>
                        <a href="/"><MdOutlineFacebook size={30} className="icon-btn-3"/></a>
                        <a href="/"><AiOutlineInstagram size={30} className="icon-btn-4"/></a>
                        </div>
                        </div>
                    </div>
