  ...
  return (
    <div>
      ...
      <div className="sort-cat">
        ...
        <select
          className="Drop_down1 mx-4"
          value={sortBy}
          onChange={(e) => {
            setSortBy(e.target.value);
          }}
        >
          <option className="select_drop" id="51" value="upcoming">
            Upcoming
          </option>
          <option className="select_drop" id="52" value="completed" required>
            Completed
          </option>
        </select>
      </div>
      <div className="scores mb-5">
        {post.matchs.map((elem, i) => {
          if (
            elem.completed === sortBy &&
            (elem.completed === "upcoming" || "completed") &&
            statsGames === elem.game
          ) {
            return (
              <ScoreCard
                flash={flash}
